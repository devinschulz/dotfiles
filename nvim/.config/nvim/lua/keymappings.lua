...
local default_keys = {
    ...
    normal_mode = {
        ...
        {"<C-Right>", ":vertical resize +2<CR>"}, {"<F5>", ":so %<CR>"}, -- source file
        ...
        {"<leader>ff", ":NvimTreeFindFile<CR>"}, -- nvim-bufferline
    ...
    term_mode = {
        ...
        -- Terminal resize
        {"<Tab>k", "<C-\\><C-N>z70<CR>i"}, {"<Tab>j", "<C-\\><C-N>z20<CR>i"}
    },
...
utils.add_keymap_visual_block_mode(opts.xnoremap,
                                   default_keys["visual_block_mode"])
